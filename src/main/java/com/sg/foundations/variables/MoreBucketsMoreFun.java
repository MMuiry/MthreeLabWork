...
public class MoreBucketsMoreFun {
    public static void main(String[] args) {
        ...
        System.out.println("... maybe my computer can't do math, after all!"); //the var bugs takes a snapshot of the current value when created and not as a contiunous reference
    }
}
